export const menuItems = {
  ...
  individuais: [
    { id: 201, name: "Uramaki de Salmão", desc: "Uramaki de salmão.", price: 16.0, img: "/img/individuais/uramaki.jpg" },
    { id: 202, name: "Hot Roll", desc: "Hot roll, sabores: salmão, Kani, skim.", price: 16.0, img: "/img/individuais/hotroll1.jpg" },
    { id: 203, name: "Hosomaki de Salmão", desc: "Hosomaki de salmão.", price: 16.0, img: "/img/individuais/hossomaki.jpg" },
    { id: 204, name: "Hot Roll Camarão", desc: "Hot Roll com camarão.", price: 25.0, img: "/img/individuais/rotrollacamarão1.jpeg" },
    { id: 205, name: "Croquete de Salmão (6 un.)", desc: "Croquete de salmão, 6 unidades.", price: 15.0, img: "/img/individuais/croquetesalm.jpg" },
  ...
  especiais: [
    { id: 301, name: "Uramaki de Kani com Camarão", desc: "Uramaki de Kani com camarão.", price: 27.0, img: "/img/especiais/uramakikanicamarao.jpeg" },
    { id: 302, name: "Uramaki Especial", desc: "Uramaki Especial.", price: 27.0, img: "/img/especiais/uramakiespecial.jpeg" },
    { id: 303, name: "Hot Especial", desc: "Hot especial da casa.", price: 22.0, img: "/img/especiais/hotrollespecial.jpg" },
    { id: 304, name: "Nathos de Salmão com Doritos", desc: "Nathos de salmão com doritos.", price: 15.0, img: "/img/especiais/natchosdoritos.jpeg" },
  ...
  temakis: [
    ...
    { id: 402, name: "Temaki de Salmão", desc: "Temaki de salmão.", price: 25.0, img: "/img/temakis/temaki.jpg" },
    { id: 403, name: "Temaki de Kani", desc: "Temaki de Kani.", price: 22.0, img: "/img/temakis/temakikani.jpeg" },
    { id: 404, name: "Temaki de Skin", desc: "Temaki de skin.", price: 21.0, img: "/img/temakis/temakiskin.jpeg" },
    { id: 405, name: "Temaki de Camarão", desc: "Temaki de camarão.", price: 30.0, img: "/img/temakis/temakicamarao.jpeg" },
  ],
  yakisoba: [
    { id: 501, name: "Yakisoba Individual", desc: "Yakisoba individual.", price: 20.0, img: "/img/yakisoba/yakisoba.jpg" },
    { id: 502, name: "Yakisoba para 2 Pessoas", desc: "Yakisoba para 2 pessoas.", price: 30.0, img: "/img/yakisoba/yakisobap2.png" },
  ],
  doces: [
  ...
  bebidas: [
    ...
    { id: 702, name: "Coca Cola Lata (350ml)", desc: "Refrigerante Coca-Cola em lata.", price: 6.0, img: "/img/bebidas/cocalata.jpg" },
    { id: 703, name: "Guaraná Antarctica (350ml)", desc: "Refrigerante Guaraná Antarctica em lata.", price: 6.0, img: "/img/bebidas/guarana.png" },
    { id: 704, name: "Guaraná Antarctica Zero (350ml)", desc: "Refrigerante Guaraná Antarctica Zero em lata.", price: 6.0, img: "/img/bebidas/guaranazero.png" },
    { id: 705, name: "H2O Limoneto (500ml)", desc: "Refrigerante H2O Limoneto em garrafa pet.", price: 7.0, img: "/img/bebidas/h2o.png" },
    { id: 706, name: "Guaraná Antarctica (1L)", desc: "Guaraná 1 Litro.", price: 10.0, img: "/img/bebidas/guarana1l.png" },
    { id: 707, name: "Água", desc: "Água mineral.", price: 3.0, img: "/img/bebidas/agua.png" },
    { id: 708, name: "Água com Gás", desc: "Água mineral com gás.", price: 4.0, img: "/img/bebidas/aguacomgas.png" },
    { id: 709, name: "Suco Copo", desc: "Suco natural no copo.", price: 8.0, img: "/img/bebidas/sucocopo.png" },
    { id: 710, name: "Suco Jarra", desc: "Suco natural na jarra.", price: 15.0, img: "/img/bebidas/sucojarra.jpg" },
    { id: 711, name: "Suco Laranja com Morango", desc: "Suco da fruta laranja com morango.", price: 10.0, img: "/img/bebidas/sucolaranjamorango.jpeg" },
  ],
};
...
export const TABS = [
  ...
  { key: 'yakisoba',    label: 'Yakisoba' },
  { key: 'doces',       label: 'Peças Doces' },
